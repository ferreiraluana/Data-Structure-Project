...
#include <limits.h>
#include <time.h>
//Tá saindo acho que certo,masssss tive uma ideia enquanto andava no escuro até as quebrada,que tal a gente só pegar o valor do
//ultimo para plotar, fica melhor né ? Ou não, num sei
